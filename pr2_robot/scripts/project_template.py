...
# Exercise-2 TODOs:
    ...
    #to romeove the two boxes for the sides
    passthrough = cloud_filtered.make_passthrough_filter()
    filter_axis = 'y'
    passthrough.set_filter_field_name(filter_axis)
    axis_min = -0.45 
    ...
    ec.set_MinClusterSize(10) #150
    ec.set_MaxClusterSize(9500) #1500
...
if __name__ == '__main__':
    ...
    object_markers_pub  = rospy.Publisher("/object_markers", Marker, queue_size=10) #queue_size was 1
    detected_objects_pub = rospy.Publisher("/detected_objects", DetectedObjectsArray, queue_size=10) #queue_size was 1
